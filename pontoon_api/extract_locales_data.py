...
def main():
    locales = [
        ...
        'ca', 'ca-valencia', 'cak', 'cs', 'cy', 'da', 'de', 'dsb', 'el',
        'en-CA', 'en-GB', 'eo', 'es-AR', 'es-CL', 'es-ES', 'es-MX', 'et', 'eu',
        'fa', 'ff', 'fi', 'fr', 'fy-NL', 'ga-IE', 'gd', 'gl', 'gn', 'gu-IN',
        'he', 'hi-IN', 'hr', 'hsb', 'hu', 'hy-AM', 'ia', 'id', 'is', 'it',
        'ja', 'ka', 'kab', 'kk', 'km', 'kn', 'ko', 'lij', 'lt', 'lv', 'mk',
        'mr', 'ms', 'my', 'nb-NO', 'ne-NP', 'nl', 'nn-NO', 'oc', 'pa-IN', 'pl',
        'pt-BR', 'pt-PT', 'rm', 'ro', 'ru', 'si', 'sk', 'sl', 'son', 'sq',
        'sr', 'sv-SE', 'ta', 'te', 'th', 'tl', 'tr', 'trs', 'uk', 'ur', 'uz',
        'vi', 'xh', 'zh-CN', 'zh-TW',
    ]
    ...
    try:
        ...
        for project in json_data['data']['projects']:
            ...
            for element in project['localizations']:
                ...
                locale_data[locale]['stats']['unreviewed'] += element['unreviewedStrings']
